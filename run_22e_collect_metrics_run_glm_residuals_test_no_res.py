...
# # LeiCA modules
from metrics import collect_metrics_residuals_test_no_res
...
working_dir = os.path.join(working_dir, 'group_metric_residuals_test_no_res')
ds_dir = os.path.join(ds_dir, 'group_metric_residuals_test_no_res')
...
for metric_name in metric_name_dict:
    ...
    collect_metrics_residuals_test_no_res.collect_3d_metrics_run_glm_residuals(cfg)
