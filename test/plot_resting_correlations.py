...
import os
import sys
from variables import working_dir, rois_list, TR_list

fwhm_list = [1,6]
thr_list = [.2]
fig_dir = '/Users/franzliem/Desktop/test_data/figs/aroma+denoise'
    ...
    for roi in rois_list:
        for fwhm in fwhm_list:
            for thr in thr_list:
                ...
                mri_file = os.path.join(working_dir, 'LeiCA_resting/sca_aromadenoise/','_TR_id_%s'%TR, '_subject_id_0103384',
